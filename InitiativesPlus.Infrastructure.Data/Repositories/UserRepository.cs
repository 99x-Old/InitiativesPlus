    ...
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<bool> AssignRoleAsync(string username, int role)
        {
            ...
            if (success)
            {
                ...
                {
                    1 => RoleTypes.User,
                    2 => RoleTypes.InitiativeLead,
                    3 => RoleTypes.SuperAdmin,
                    4 => RoleTypes.InitiativeEvaluator,
